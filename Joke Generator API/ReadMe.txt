...
the function "fetchData" fetches the joke data from the url and parses it into JS. I then calls one of the two "generateHTML" functions to insert the joke into the html.
